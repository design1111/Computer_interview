...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#简要概括)简要概括
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#说明)说明
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#总结)总结
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_2、说一下一次完整的http请求过程包括哪些内容)2、说一下一次完整的HTTP请求过程包括哪些内容？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#第一种回答)第一种回答
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#第二种回答)第二种回答

域名解析 --> 发起TCP的3次握手 --> 建立TCP连接后发起http请求 --> 服务器响应http请求，浏览器得到html代码 --> 浏览器解析html代码，并请求html代码中的资源（如js、css、图片等） --> 浏览器对页面进行渲染呈现给用户。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_3、你知道dns是什么)3、你知道DNS是什么？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_4、dns的工作原理)4、DNS的工作原理？

将主机域名转换为ip地址，属于应用层协议，使用UDP传输。（DNS应用层协议，以前有个考官问过）

![img](http://oss.interviewguide.cn/img/202205220036790.png) 过程： 总结： 浏览器缓存，系统缓存，路由器缓存，IPS服务器缓存，根域名服务器缓存，顶级域名服务器缓存，主域名服务器缓存。 一、主机向本地域名服务器的查询一般都是采用递归查询。 二、本地域名服务器向根域名服务器的查询的迭代查询。
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_5、为什么域名解析用udp协议)5、为什么域名解析用UDP协议？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_6、为什么区域传送用tcp协议)6、为什么区域传送用TCP协议？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_7、http长连接和短连接的区别)7、HTTP长连接和短连接的区别
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_8、什么是tcp粘包-拆包-发生的原因)8、什么是TCP粘包/拆包？发生的原因？

一个完整的业务可能会被TCP拆分成多个包进行发送，也有可能把多个小的包封装成一个大的数据包发送，这个就是TCP的拆包和粘包问题。

##### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#原因)原因
...
##### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#解决方案)解决方案
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_9、为什么服务器会缓存这一项功能-如何实现的)9、为什么服务器会缓存这一项功能?如何实现的？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_10、http请求方法你知道多少)10、HTTP请求方法你知道多少？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_11、get-和-post-的区别-你知道哪些)11、GET 和 POST 的区别，你知道哪些？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_12、一个tcp连接可以对应几个http请求)12、一个TCP连接可以对应几个HTTP请求？

如果维持连接，一个 TCP 连接是可以发送多个 HTTP 请求的。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_13、一个-tcp-连接中-http-请求发送可以一起发送么-比如一起发三个请求-再三个响应一起接收)13、一个 TCP 连接中 HTTP 请求发送可以一起发送么（比如一起发三个请求，再三个响应一起接收）？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_14、浏览器对同一-host-建立-tcp-连接到的数量有没有限制)14、浏览器对同一 Host 建立 TCP 连接到的数量有没有限制？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_15、在浏览器中输入url地址后显示主页的过程)15、在浏览器中输入url地址后显示主页的过程?
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_16、在浏览器地址栏输入一个url后回车-背后会进行哪些技术步骤)16、在浏览器地址栏输入一个URL后回车，背后会进行哪些技术步骤？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#第一种回答-2)第一种回答
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#第二种回答-2)第二种回答
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_17、谈谈dns解析过程-具体一点)17、谈谈DNS解析过程，具体一点
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_18、dns负载均衡是什么策略)18、DNS负载均衡是什么策略？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_19、https和http的区别)19、HTTPS和HTTP的区别
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-01-net.html#_20、什么是ssl-tls)20、什么是SSL/TLS ？
...
> 感谢网友提出补充，已补充，2021.10.12[https://github.com/forthespada/InterviewGuide/issues/15(opens new window)](https://github.com/forthespada/InterviewGuide/issues/15)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_22、如何保证公钥不被篡改)22、如何保证公钥不被篡改？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_23、http请求和响应报文有哪些主要字段)23、HTTP请求和响应报文有哪些主要字段？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#请求报文)请求报文
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#响应报文)响应报文
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_24、cookie是什么)24、Cookie是什么？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_25、cookie有什么用途-用途)25、Cookie有什么用途？用途
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_26、session知识大总结)26、Session知识大总结
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_27、session-的工作原理是什么)27、Session 的工作原理是什么？

session 的工作原理是客户端登录完成之后，服务器会创建对应的 session，session 创建完之后，会把 session 的 id 发送给客户端，客户端再存储到浏览器中。这样客户端每次访问服务器时，都会带着 sessionid，服务器拿到 sessionid 之后，在内存找到与之对应的 session 这样就可以正常工作了。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_28、cookie与session的对比)28、Cookie与Session的对比

HTTP作为无状态协议，必然需要在某种方式保持连接状态。这里简要介绍一下Cookie和Session。

- ##### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#cookie)Cookie
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_29、sql注入攻击了解吗)29、SQL注入攻击了解吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_30、网络的七层模型与各自的功能-图片版)30、网络的七层模型与各自的功能（图片版）

![img](http://oss.interviewguide.cn/img/202205072300304.png)

![img](http://oss.interviewguide.cn/img/202205072300887.png)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_31、什么是rarp-工作原理)31、什么是RARP？工作原理
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_32、端口有效范围是多少到多少)32、端口有效范围是多少到多少？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_33、为何需要把-tcp-ip-协议栈分成-5-层-或7层-开放式回答。)33、为何需要把 TCP/IP 协议栈分成 5 层（或7层）？开放式回答。
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_34、dns查询方式有哪些)34、DNS查询方式有哪些？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#递归解析)递归解析
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#迭代解析)迭代解析
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_35、http中缓存的私有和共有字段-知道吗)35、HTTP中缓存的私有和共有字段？知道吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_36、get-方法参数写法是固定的吗)36、GET 方法参数写法是固定的吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_37、get-方法的长度限制是怎么回事)37、GET 方法的长度限制是怎么回事？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_38、post-方法比-get-方法安全)38、POST 方法比 GET 方法安全？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-02-net.html#_39、post-方法会产生两个-tcp-数据包-你了解吗)39、POST 方法会产生两个 TCP 数据包？你了解吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_42、session和cookie应该如何去选择-适用场景)42、Session和cookie应该如何去选择（适用场景）？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_43、cookies和session区别是什么)43、Cookies和Session区别是什么？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_44、ddos-攻击了解吗)44、DDos 攻击了解吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_45、mtu和mss分别是什么)45、MTU和MSS分别是什么？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_46、http中有个缓存机制-但如何保证缓存是最新的呢-缓存过期机制)46、HTTP中有个缓存机制，但如何保证缓存是最新的呢？（缓存过期机制）
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_47、tcp头部中有哪些信息)47、TCP头部中有哪些信息？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_48、常见tcp的连接状态有哪些)48、常见TCP的连接状态有哪些？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_49、网络的七层-五层模型主要的协议有哪些)49、网络的七层/五层模型主要的协议有哪些？

![img](http://oss.interviewguide.cn/img/202205072300758.png)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_50、tcp是什么)50、TCP是什么？

TCP（Transmission Control Protocol 传输控制协议）是一种面向连接的、可靠的、基于字节流的传输层通信协议。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_51、tcp头部报文字段介绍几个-各自的功能)51、TCP头部报文字段介绍几个？各自的功能？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_52、osi-的七层模型的主要功能)52、OSI 的七层模型的主要功能？

![img](http://oss.interviewguide.cn/img/202205072300329.png)
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_53、应用层常见协议知道多少-了解几个)53、应用层常见协议知道多少？了解几个？
...
> 感谢网友勘误”TFTP简单文件传输协议 初始默认端口号69“，已修正，2021.10.12[https://github.com/forthespada/InterviewGuide/issues/13(opens new window)](https://github.com/forthespada/InterviewGuide/issues/13)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_54、浏览器在与服务器建立了一个-tcp-连接后是否会在一个-http-请求完成后断开-什么情况下会断开)54、浏览器在与服务器建立了一个 TCP 连接后是否会在一个 HTTP 请求完成后断开？什么情况下会断开？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_55、三次握手相关内容)55、三次握手相关内容

![img](http://oss.interviewguide.cn/img/202205072301822.png)
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_57、什么是半连接队列)57、什么是半连接队列？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_58、-isn-initial-sequence-number-是固定的吗)58、 ISN(Initial Sequence Number)是固定的吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_59、-三次握手过程中可以携带数据吗)59、 三次握手过程中可以携带数据吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-03-net.html#_60、syn攻击是什么)60、SYN攻击是什么？
...
![img](http://oss.interviewguide.cn/img/202205220036404.png)
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#第一种回答)第一种回答
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#第二种回答)第二种回答
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_66、tcp粘包问题是什么-你会如何去解决它)66、TCP粘包问题是什么？你会如何去解决它？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_67、osi七层模型中表示层和会话层功能是什么)67、OSI七层模型中表示层和会话层功能是什么？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_68、三次握手四次挥手的变迁图)68、三次握手四次挥手的变迁图

《TCP/IP详解 卷1:协议》有一张TCP状态变迁图，很具有代表性，有助于大家理解三次握手和四次挥手的状态变化。如下图所示，粗的实线箭头表示正常的客户端状态变迁，粗的虚线箭头表示正常的服务器状态变迁。

![img](http://oss.interviewguide.cn/img/202205220036408.png)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_69、对称密钥加密的优点缺点)69、对称密钥加密的优点缺点？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_70、非对称密钥加密你了解吗-优缺点)70、非对称密钥加密你了解吗？优缺点？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_71、https是什么)71、HTTPS是什么？

HTTPS 并不是新协议，而是让 **HTTP 先和 SSL（Secure Sockets Layer）通信，再由 SSL 和 TCP 通信，也就是说 HTTPS 使用了隧道进行通信**。通过使用 SSL，HTTPS 具有了加密（防窃听）、认证（防伪装）和完整性保护（防篡改）。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_72、http的缺点有哪些)72、HTTP的缺点有哪些？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_73、https采用的加密方式有哪些-是对称还是非对称)73、HTTPS采用的加密方式有哪些？是对称还是非对称？

HTTPS 采用混合的加密机制，使用**非对称密钥加密用于传输对称密钥来保证传输过程的安全性**，之后使用**对称密钥加密进行通信来保证通信过程的效率**。

![img](http://oss.interviewguide.cn/img/202205220036403.png)
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_74、为什么有的时候刷新页面不需要重新建立-ssl-连接)74、为什么有的时候刷新页面不需要重新建立 SSL 连接？

TCP 连接有的时候会被浏览器和服务端维持一段时间，TCP 不需要重新建立，SSL 自然也会用之前的。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_75、ssl中的认证中的证书是什么-了解过吗)75、SSL中的认证中的证书是什么？了解过吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_76、http如何禁用缓存-如何确认缓存)76、HTTP如何禁用缓存？如何确认缓存？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_77、get与post传递数据的最大长度能够达到多少呢)77、GET与POST传递数据的最大长度能够达到多少呢？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_78、网络层常见协议-可以说一下吗)78、网络层常见协议？可以说一下吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#_79、tcp四大拥塞控制算法总结-极其重要)79、TCP四大拥塞控制算法总结？（极其重要）

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-04-net.html#四大算法)**四大算法**

拥塞控制主要是四个算法：1）慢启动，2）拥塞避免，3）拥塞发生，4）快速恢复。这四个算法不是一天都搞出来的，这个四算法的发展经历了很多时间，到今天都还在优化中。

![img](http://oss.interviewguide.cn/img/202205220036635.png)
...
![img](http://oss.interviewguide.cn/img/202205220036573.png)
...
- 如果收到新的ACK，表明重传的包成功了，那么退出快速恢复算法。将cwnd设置为ssthresh，然后进入拥塞避免算法。
  ...
  ![img](http://oss.interviewguide.cn/img/202205220036984.png)
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_81、对于fin-wait-2-close-wait状态和time-wait状态-你知道多少)81、对于FIN_WAIT_2，CLOSE_WAIT状态和TIME_WAIT状态？你知道多少?
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_82、你了解流量控制原理吗)82、你了解流量控制原理吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_83、建立tcp服务器的各个系统调用过程是怎样的)83、建立TCP服务器的各个系统调用过程是怎样的？

![img](http://oss.interviewguide.cn/img/202205220023934.png)

![img](http://oss.interviewguide.cn/img/202205220023348.png)
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_84、tcp-协议如何保证可靠传输)84、TCP 协议如何保证可靠传输？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#第一种回答)第一种回答
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#第二种回答)第二种回答
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#第三种回答)第三种回答
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_85、udp是什么)85、UDP是什么？

提供**无连接**的，尽最大努力的数据传输服务（**不保证数据传输的可靠性**）。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_86、tcp和udp的区别)86、TCP和UDP的区别
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#补充题-封包和拆包你听说过吗-它是基于tcp还是udp的)补充题：封包和拆包你听说过吗？它是基于TCP还是UDP的？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_87、udp的特点有哪些-附赠tcp的特点)87、UDP的特点有哪些（附赠TCP的特点）？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_88、tcp对应的应用层协议)88、TCP对应的应用层协议

FTP：定义了文件传输协议，使用21端口. Telnet：它是一种用于远程登陆的端口,23端口 SMTP：定义了简单邮件传送协议，服务器开放的是25号端口。 POP3：它是和SMTP对应，POP3用于接收邮件。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_89、udp对应的应用层协议)89、UDP对应的应用层协议

DNS：用于域名解析服务，用的是53号端口 SNMP：简单网络管理协议，使用161号端口 TFTP(Trival File Transfer Protocal)：简单文件传输协议，69



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_90、数据链路层常见协议-可以说一下吗)90、数据链路层常见协议？可以说一下吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_91、ping命令基于什么协议-原理是什么)91、Ping命令基于什么协议？原理是什么？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_92、在进行udp编程的时候-一次发送多少bytes好)92、在进行UDP编程的时候，一次发送多少bytes好?
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_93、tcp-利用滑动窗口实现流量控制的机制)93、TCP 利用滑动窗口实现流量控制的机制？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_94、可以解释一下rto-rtt和超时重传分别是什么吗)94、可以解释一下RTO，RTT和超时重传分别是什么吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_95、xss攻击是什么-低频)95、XSS攻击是什么？（低频）
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_96、csrf攻击-你知道吗)96、CSRF攻击？你知道吗？

跨站点请求伪造，指攻击者通过跨站请求，以合法的用户的身份进行非法操作。可以这么理解CSRF攻击：攻击者盗用你的身份，以你的名义向第三方网站发送恶意请求。CRSF能做的事情包括利用你的身份发邮件，发短信，进行交易转账，甚至盗取账号信息。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_97、如何防范csrf攻击)97、如何防范CSRF攻击
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_98、文件上传漏洞是如何发生的-你有经历过吗)98、文件上传漏洞是如何发生的？你有经历过吗？

文件上传漏洞，指的是用户上传一个可执行的脚本文件，并通过此脚本文件获得了执行服务端命令的能力。 许多第三方框架、服务，都曾经被爆出文件上传漏洞，比如很早之前的Struts2，以及富文本编辑器等等，可被攻击者上传恶意代码，有可能服务端就被人黑了。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_99、如何防范文件上传漏洞)99、如何防范文件上传漏洞
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-05-net.html#_100、拥塞控制原理听说过吗)100、拥塞控制原理听说过吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-06-net.html#_102、常见的http状态码有哪些)102、常见的HTTP状态码有哪些？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-06-net.html#_103、服务器出现大量close-wait的连接的原因是什么-有什么解决方法)103、服务器出现大量close_wait的连接的原因是什么？有什么解决方法？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-06-net.html#_104、一台机器能够使用的端口号上限是多少-是否可以修改-如果想要用的端口超过这个限制怎么办)104、一台机器能够使用的端口号上限是多少，是否可以修改？如果想要用的端口超过这个限制怎么办？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/03-06-net.html#参考文献)参考文献

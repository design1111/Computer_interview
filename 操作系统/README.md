...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_4、外中断和异常有什么区别)4、外中断和异常有什么区别？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_5、进程线程模型你知道多少)5、进程线程模型你知道多少？

对于进程和线程的理解和把握可以说基本奠定了对系统的认知和把控能力。其核心意义绝不仅仅是“线程是调度的基本单位，进程是资源分配的基本单位”这么简单。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#多线程)多线程
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#多进程)多进程
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_6、进程调度算法你了解多少)6、进程调度算法你了解多少？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_1、-先来先服务-first-come-first-serverd-fcfs)1、 **先来先服务 first-come first-serverd（FCFS）**

非抢占式的调度算法，按照请求的顺序进行调度。

有利于长作业，但不利于短作业，因为短作业必须一直等待前面的长作业执行完毕才能执行，而长作业又需要执行很长时间，造成了短作业等待时间过长。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_2、-短作业优先-shortest-job-first-sjf)2、 **短作业优先 shortest job first（SJF）**

非抢占式的调度算法，按估计运行时间最短的顺序进行调度。

长作业有可能会饿死，处于一直等待短作业执行完毕的状态。因为如果一直有短作业到来，那么长作业永远得不到调度。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_3、最短剩余时间优先-shortest-remaining-time-next-srtn)3、**最短剩余时间优先 shortest remaining time next（SRTN）**

最短作业优先的抢占式版本，按剩余运行时间的顺序进行调度。 当一个新的作业到达时，其整个运行时间与当前进程的剩余时间作比较。

如果新的进程需要的时间更少，则挂起当前进程，运行新的进程。否则新的进程等待。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_4、时间片轮转)4、**时间片轮转**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_5、优先级调度)5、**优先级调度**

为每个进程分配一个优先级，按优先级进行调度。

为了防止低优先级的进程永远等不到调度，可以随着时间的推移增加等待进程的优先级。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_6、多级反馈队列)6、**多级反馈队列**
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_7、linux下进程间通信方式)7、Linux下进程间通信方式？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_8、linux下同步机制)8、Linux下同步机制？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_9、如果系统中具有快表后-那么地址的转换过程变成什么样了)9、如果系统中具有快表后，那么地址的转换过程变成什么样了？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_10、内存交换和覆盖有什么区别)10、内存交换和覆盖有什么区别？

交换技术主要是在不同进程（或作业）之间进行，而覆盖则用于同一程序或进程中。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_11、动态分区分配算法有哪几种-可以分别说说吗)11、动态分区分配算法有哪几种？可以分别说说吗？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_1、首次适应算法)1、首次适应算法

算法思想：每次都从低地址开始查找，找到第–个能满足大小的空闲分区。

如何实现：空闲分区以地址递增的次序排列。每次分配内存时顺序查找空闲分区链( 或空闲分[表)，找到大小能满足要求的第-一个空闲分区。

![img](http://oss.interviewguide.cn/img/202205220001798.png)

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_2、最佳适应算法)2、最佳适应算法

算法思想:由于动态分区分配是一种连续分配方式，为各进程分配的空间必须是连续的一整片区域。因此为了保证当“大进程”到来时能有连续的大片空间，可以尽可能多地留下大片的空闲区,即，优先使用更小的空闲区。

如何实现:空闲分区按容量递增次序链接。每次分配内存时顺序查找空闲分区链(或空闲分区表)，找到大小能满足要求的第-一个空闲分区。 ![img](http://oss.interviewguide.cn/img/202205220001901.png)

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_3、最坏适应算法)3、最坏适应算法

又称最大适应算法(Largest Fit)

算法思想:为了解决最佳适应算法的问题—即留下太多难以利用的小碎片，可以在每次分配时优先使用最大的连续空闲区，这样分配后剩余的空闲区就不会太小，更方便使用。

如何实现:空闲分区按容量递减次序链接。每次分配内存时顺序查找空闲分区链(或空闲分区表)，找到大小能满足要求的第-一个空闲分区。 ![img](http://oss.interviewguide.cn/img/202205220001434.png)

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_4、邻近适应算法)4、邻近适应算法

算法思想：首次适应算法每次都从链头开始查找的。这可能会导致低地址部分出现很多小的空闲分区，而每次分配查找时，都要经过这些分区，因此也增加了查找的开销。如果每次都从上次查找结束的位置开始检索，就能解决上述问题。

如何实现：空闲分区以地址递增的顺序排列(可排成-一个循环链表)。每次分配内存时从上次查找结束的位置开始查找空闲分区链(或空闲分区表)，找到大小能满足要求的第一个空闲分区。 ![img](http://oss.interviewguide.cn/img/202205220001500.png)

##### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_5、总结)5、总结
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_12、虚拟技术你了解吗)12、虚拟技术你了解吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_13、进程状态的切换你知道多少)13、进程状态的切换你知道多少？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_14、一个c-c-程序从开始编译到生成可执行文件的完整过程-你能说出来多少)14、一个C/C++程序从开始编译到生成可执行文件的完整过程，你能说出来多少？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_15、通过例子讲解逻辑地址转换为物理地址的基本过程)15、通过例子讲解逻辑地址转换为物理地址的基本过程
...
![img](http://oss.interviewguide.cn/img/202205220001941.png)

![img](http://oss.interviewguide.cn/img/202205220001638.png) 例:若页面大小L为1K字节，页号2对应的内存块号b=8，将逻辑地址A=2500转换为物理地址E。 等价描述：某系统按字节寻址，逻辑地址结构中，页内偏移量占10位(说明一个页面的大小为2^10B = 1KB)，页号2对应的内存块号 b=8，将逻辑地址A=2500转换为物理地址E。
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_16、进程同步的四种方法)16、进程同步的四种方法？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_1-临界区)1. 临界区
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_2-同步与互斥)2. 同步与互斥

- 同步：多个进程因为合作产生的直接制约关系，使得进程有一定的先后执行关系。
- 互斥：多个进程在同一时刻只有一个进程能进入临界区。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_3-信号量)3. 信号量
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_4-管程)4. 管程
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_17、操作系统在对内存进行管理的时候需要做些什么)17、操作系统在对内存进行管理的时候需要做些什么?
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_18、进程通信方法-linux和windows下-线程通信方法-linux和windows下)18、进程通信方法（Linux和windows下），线程通信方法（Linux和windows下）

**进程通信方法**

![img](http://oss.interviewguide.cn/img/202205220001927.png)
...
![img](http://oss.interviewguide.cn/img/202205220001656.png)
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_19、进程间通信有哪几种方式-把你知道的都说出来)19、进程间通信有哪几种方式？把你知道的都说出来

Linux几乎支持全部UNIX进程间通信方法，包括管道（有名管道和无名管道）、消息队列、共享内存、信号量和套接字。其中前四个属于同一台机器下进程间的通信，套接字则是用于网络通信。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#管道)管道
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#消息队列)消息队列
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#共享内存)共享内存
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#信号量)信号量
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#辅助命令)辅助命令
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#套接字)套接字

与其它通信机制不同的是，它可用于不同机器间的进程通信。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-01-os.html#_20、虚拟内存的目的是什么)20、虚拟内存的目的是什么？
...
![img](http://oss.interviewguide.cn/img/202205220001833.png)



## 21、说一下你理解中的内存？他有什么作用呢？

![img](http://oss.interviewguide.cn/img/202205212343183.png)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_22、操作系统经典问题之哲学家进餐问题)22、操作系统经典问题之哲学家进餐问题
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_23、操作系统经典问题之读者-写者问题)23、操作系统经典问题之读者-写者问题
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_24、介绍一下几种典型的锁)24、介绍一下几种典型的锁？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#读写锁)读写锁

- 多个读者可以同时进行读
- 写者必须互斥（只允许一个写者写，也不能读者写者同时进行）
- 写者优先于读者（一旦有写者，则后续读者必须等待，唤醒时优先考虑写者）

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#互斥锁)互斥锁

一次只能一个线程拥有互斥锁，其他线程只有等待

互斥锁是在抢锁失败的情况下主动放弃CPU进入睡眠状态直到锁的状态改变时再唤醒，而操作系统负责线程调度，为了实现锁的状态发生改变时唤醒阻塞的线程或者进程，需要把锁交给操作系统管理，所以互斥锁在加锁操作时涉及上下文的切换。互斥锁实际的效率还是可以让人接受的，加锁的时间大概100ns左右，而实际上互斥锁的一种可能的实现是先自旋一段时间，当自旋的时间超过阀值之后再将线程投入睡眠中，因此在并发运算中使用互斥锁（每次占用锁的时间很短）的效果可能不亚于使用自旋锁

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#条件变量)条件变量
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#自旋锁)自旋锁

如果进线程无法取得锁，进线程不会立刻放弃CPU时间片，而是一直循环尝试获取锁，直到获取为止。如果别的线程长时期占有锁，那么自旋就是在浪费CPU做无用功，但是自旋锁一般应用于加锁时间很短的场景，这个时候效率比较高。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_24-1、你知道哪几种线程锁-posix)24.1、你知道哪几种线程锁（POSIX）？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#互斥锁-mutex)**互斥锁（mutex）**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#条件变量-cond)**条件变量(cond)**

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#自旋锁-spin)**自旋锁(spin)**
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_25、逻辑地址vs物理地址)25、逻辑地址VS物理地址

Eg:编译时只需确定变量x存放的相对地址是100 ( 也就是说相对于进程在内存中的起始地址而言的地址)。CPU想要找到x在内存中的实际存放位置，只需要用进程的起始地址+100即可。 相对地址又称逻辑地址，绝对地址又称物理地址。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_26、怎么回收线程-有哪几种方法)26、怎么回收线程？有哪几种方法？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_27、内存的覆盖是什么-有什么特点)27、内存的覆盖是什么？有什么特点？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_28、内存交换是什么-有什么特点)28、内存交换是什么？有什么特点？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_29、什么时候会进行内存的交换)29、什么时候会进行内存的交换？

内存交换通常在许多进程运行且内存吃紧时进行，而系统负荷降低就暂停。例如:在发现许多进程运行时经常发生缺页，就说明内存紧张，此时可以换出一些进程;如果缺页率明显下降，就可以暂停换出。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_30、终端退出-终端运行的进程会怎样)30、终端退出，终端运行的进程会怎样

终端在退出时会发送SIGHUP给对应的bash进程，bash进程收到这个信号后首先将它发给session下面的进程，如果程序没有对SIGHUP信号做特殊处理，那么进程就会随着终端关闭而退出



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_31、如何让进程后台运行)31、如何让进程后台运行
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_32、什么是快表-你知道多少关于快表的知识)32、什么是快表，你知道多少关于快表的知识？

快表，又称联想寄存器(TLB) ，是一种访问速度比内存快很多的高速缓冲存储器，用来存放当前访问的若干页表项，以加速地址变换的过程。与此对应，内存中的页表常称为慢表。

![img](http://oss.interviewguide.cn/img/202205212343703.png)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_33、地址变换中-有快表和没快表-有什么区别)33、地址变换中，有快表和没快表，有什么区别？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_34、在执行malloc申请内存的时候-操作系统是怎么做的)34、在执行malloc申请内存的时候，操作系统是怎么做的？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_35、-守护进程、僵尸进程和孤儿进程)35、 守护进程、僵尸进程和孤儿进程

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#守护进程)守护进程
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#孤儿进程)孤儿进程

如果父进程先退出，子进程还没退出，那么子进程的父进程将变为init进程。（注：任何一个进程都必须有父进程）。

一个父进程退出，而它的一个或多个子进程还在运行，那么那些子进程将成为孤儿进程。孤儿进程将被init进程(进程号为1)所收养，并由init进程对它们完成状态收集工作。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#僵尸进程)僵尸进程
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_36、如何避免僵尸进程)36、如何避免僵尸进程？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_37、局部性原理你知道吗-主要有哪两大局部性原理-各自是什么)37、局部性原理你知道吗？主要有哪两大局部性原理？各自是什么？
...
![img](http://oss.interviewguide.cn/img/202205212344455.png)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_38、父进程、子进程、进程组、作业和会话)38、父进程、子进程、进程组、作业和会话

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#父进程)父进程

已创建一个或多个子进程的进程

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#子进程)子进程
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#进程组)进程组

进程组就是多个进程的集合，其中肯定有一个组长，其进程PID等于进程组的PGID。只要在某个进程组中一个进程存在，该进程组就存在，这与其组长进程是否终止无关。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#作业)作业

shell分前后台来控制的不是进程而是作业（job）或者进程组（Process Group）。

一个前台作业可以由多个进程组成，一个后台也可以由多个进程组成，shell可以运行一个前台作业和任意多个后台作业，这称为作业控制

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#为什么只能运行一个前台作业)**为什么只能运行一个前台作业？**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#会话)会话

会话（Session）是一个或多个进程组的集合。一个会话可以有一个控制终端。在xshell或者WinSCP中打开一个窗口就是新建一个会话。



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_39、进程终止的几种方式)39、进程终止的几种方式
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#_40、linux中异常和中断的区别)40、Linux中异常和中断的区别

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#中断)**中断**
...
![img](http://oss.interviewguide.cn/img/202205212344538.png)
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#异常)**异常**
...
![img](http://oss.interviewguide.cn/img/202205212344494.png)

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#相同点)**相同点**

- 最后都是由CPU发送给内核，由内核去处理
- 处理程序的流程设计上是相似的

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-02-os.html#不同点)**不同点**
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_42、一个由c-c-编译的程序占用的内存分为哪几个部分)42、一个由C/C++编译的程序占用的内存分为哪几个部分？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_43、一般情况下在linux-windows平台下栈空间的大小)43、一般情况下在Linux/windows平台下栈空间的大小

Linux环境下有操作系统决定，一般是8MB，8192KB，通过ulimit命令查看以及修改

Windows环境下由编译器决定，VC++6.0一般是1M

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#linux)**Linux**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#windows)**Windows**
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_44、程序从堆中动态分配内存时-虚拟内存上怎么操作的)44、程序从堆中动态分配内存时，虚拟内存上怎么操作的
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_45、常见的几种磁盘调度算法)45、常见的几种磁盘调度算法
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_1-先来先服务)1. 先来先服务

按照磁盘请求的顺序进行调度。

优点是公平和简单。缺点也很明显，因为未对寻道做任何优化，使平均寻道时间可能较长。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_2-最短寻道时间优先)2. 最短寻道时间优先

优先调度与当前磁头所在磁道距离最近的磁道。

虽然平均寻道时间比较低，但是不够公平。如果新到达的磁道请求总是比一个在等待的磁道请求近，那么在等待的磁道请求会一直等待下去，也就是出现饥饿现象。具体来说，两端的磁道请求更容易出现饥饿现象。

![img](http://oss.interviewguide.cn/img/202205212344899.png)

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_3-电梯扫描算法)3. 电梯扫描算法
...
![img](http://oss.interviewguide.cn/img/202205212344070.png)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_46、交换空间与虚拟内存的关系)46、交换空间与虚拟内存的关系

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#交换空间)**交换空间**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#虚拟内存)**虚拟内存**
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_47、抖动你知道是什么吗-它也叫颠簸现象)47、抖动你知道是什么吗？它也叫颠簸现象
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_48、从堆和栈上建立对象哪个快-考察堆和栈的分配效率比较)48、从堆和栈上建立对象哪个快？（考察堆和栈的分配效率比较）
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_49、常见内存分配方式有哪些)49、常见内存分配方式有哪些？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_50、常见内存分配内存错误)50、常见内存分配内存错误
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_51、内存交换中-被换出的进程保存在哪里)51、内存交换中，被换出的进程保存在哪里？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_52、在发生内存交换时-有些进程是被优先考虑的-你可以说一说吗)52、在发生内存交换时，有些进程是被优先考虑的？你可以说一说吗？

可优先换出阻塞进程;可换出优先级低的进程;为了防止优先级低的进程在被调入内存后很快又被换出，有的系统还会考虑进程在内存的驻留时间… (注意: PCB 会常驻内存，不会被换出外存)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_53、ascii、unicode和utf-8编码的区别)53、ASCII、Unicode和UTF-8编码的区别？

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#ascii)**ASCII**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#unicode)**Unicode**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#utf-8)**UTF-8**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#三者之间的联系)**三者之间的联系**
...
![img](http://oss.interviewguide.cn/img/202205212345239.png)

浏览网页的时候，服务器会把动态生成的Unicode内容转换为UTF-8再传输到浏览器：

![img](http://oss.interviewguide.cn/img/202205212345501.png)



## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_54、原子操作的是如何实现的)54、原子操作的是如何实现的
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_55、内存交换你知道有哪些需要注意的关键点吗)55、内存交换你知道有哪些需要注意的关键点吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_56、系统并发和并行-分得清吗)56、系统并发和并行，分得清吗？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_57、可能是最全的页面置换算法总结了)57、可能是最全的页面置换算法总结了

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_1、最佳置换法-opt)1、最佳置换法(OPT)

最佳置换算法(OPT，Optimal) :每次选择淘汰的页面将是以后永不使用，或者在最长时间内不再被访问的页面，这样可以保证最低的缺页率。 ![img](http://oss.interviewguide.cn/img/202205212345108.png) 最佳置换算法可以保证最低的缺页率，但实际上，只有在进程执行的过程中才能知道接下来会访问到的是哪个页面。操作系统无法提前预判页面访问序列。因此，最佳置换算法是无法实现的

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_2、先进先出置换算法-fifo)2、先进先出置换算法(FIFO)

先进先出置换算法(FIFO) :每次选择淘汰的页面是最早进入内存的页面 实现方法:把调入内存的页面根据调入的先后顺序排成一个队列，需要换出页面时选择队头页面队列的最大长度取决于系统为进程分配了多少个内存块。 ![img](http://oss.interviewguide.cn/img/202205212345413.png)

![img](http://oss.interviewguide.cn/img/202205212345552.png)Belady异常—当为进程分配的物理块数增大时，缺页次数不减反增的异常现象。
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_3、最近最久未使用置换算法-lru)3、最近最久未使用置换算法(LRU)
...
![img](http://oss.interviewguide.cn/img/202205212345619.png) 在手动做题时，若需要淘汰页面，可以逆向检查此时在内存中的几个页面号。在逆向扫描过程中最后一个出现的页号就是要淘汰的页面。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_4、时钟置换算法-clock)4、时钟置换算法(CLOCK)
...
![img](http://oss.interviewguide.cn/img/202205212345526.png)

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_5、改进型的时钟置换算法)5、改进型的时钟置换算法
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_58、共享是什么)58、共享是什么？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_59、死锁相关问题大总结-超全)59、死锁相关问题大总结，超全！

**死锁是指两个（多个）线程相互等待对方数据的过程，死锁的产生会导致程序卡死，不解锁程序将永远无法进行下去。**

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_1、死锁产生原因)1、死锁产生原因
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_2、死锁演示)2、死锁演示
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_3、死锁的解决方案)3、死锁的解决方案

 保证上锁的顺序一致。

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_4、死锁必要条件)4、死锁必要条件
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_5、处理方法)5、处理方法
...
#### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#鸵鸟策略)**鸵鸟策略**
...
#### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#死锁检测与死锁恢复)**死锁检测与死锁恢复**
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_6、死锁恢复)6、死锁恢复

- 利用抢占恢复
- 利用回滚恢复
- 通过杀死进程恢复

### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_7、死锁预防)7、死锁预防
...
### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_8、死锁避免)8、死锁避免

在程序运行时避免发生死锁。

1. #### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#安全状态)**安全状态**
...
1. #### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#单个资源的银行家算法)**单个资源的银行家算法**
...
1. #### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#多个资源的银行家算法)**多个资源的银行家算法**

![img](http://oss.interviewguide.cn/img/202205212345258.png)

上图中有五个进程，四个资源。左边的图表示已经分配的资源，右边的图表示还需要分配的资源。最右边的 E、P 以及 A 分别表示：总资源、已分配资源以及可用资源，注意这三个为向量，而不是具体数值，例如 A=(1020)，表示 4 个资源分别还剩下 1/0/2/0。

#### [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_4、检查一个状态是否安全的算法如下)4、**检查一个状态是否安全的算法如下**：
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-03-os.html#_60、为什么分段式存储管理有外部碎片而无内部碎片-为什么固定分区分配有内部碎片而不会有外部碎片)60、为什么分段式存储管理有外部碎片而无内部碎片？为什么固定分区分配有内部碎片而不会有外部碎片？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-04-os.html#_62、如何消除碎片文件)62、如何消除碎片文件
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-04-os.html#_63、冯诺依曼结构有哪几个模块-分别对应现代计算机的哪几个部分-百度安全一面)63、冯诺依曼结构有哪几个模块？分别对应现代计算机的哪几个部分？（百度安全一面）
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-04-os.html#_64、多进程和多线程的区别是什么-换句话说-什么时候该用多线程-什么时候该用多进程)64、多进程和多线程的区别是什么？换句话说，什么时候该用多线程，什么时候该用多进程？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-04-os.html#_65、服务器高并发的解决方案你知道多少)65、服务器高并发的解决方案你知道多少？
...
## [#](https://interviewguide.cn/notes/03-hunting_job/02-interview/02-04-os.html#参考文献)参考文献
...
进程中的最小执行单位就是线程，多线程是指从软件或者硬件上实现多个线程并发执行的技术。
...
（2）进程是系统进行资源分配和调度的基本单位，且每个进程拥有独⽴的地址空间；
...
```
读写锁允许多个线程同时读取共享资源，但只允许一个线程写入共享资源。这种机制适用于读操作频繁而写操作较少的场景，可以提高程序的并发性能。读写锁通过 pthread_rwlock_init()、pthread_rwlock_rdlock() 和 pthread_rwlock_wrlock() 等函数来进行操作。
```
...
详细参考：[详细介绍线程间通信-阿里云开发者社区 (aliyun.com)](https://developer.aliyun.com/article/1390178)
...
## 10、孤⼉进程和僵⼫进程的区别？怎么避免这两类进程？守护进程？
...
2、 如果**⼦进程先退出了，⽗进程还未结束并且没有调⽤ wait 或者 waitpid 函数获取⼦进程的状态信息，则⼦进程残留的状态信息（ task_struct 结构和少量资源信息）会变成僵⼫进程**。⼦进程退出时向⽗进程发送SIGCHILD信号，⽗进程处理SIGCHILD信号。在信号处理函数中调⽤wait进⾏处理僵⼫进程。
...
是一种传统的存储器设计思想，指令和数据是不加区分地混合存储在同一个存储器中，共享数据总线。指令地址和数据地址指向同一个存储器地不同物理位置，指令和数据地宽度相同。

由于指令和数据存放在同一存储器中，因此冯诺·伊曼结构中不能同时取指令和取操作数。又因为存储器存取速度远远低于CPU运算速度，从而使计算机运算速度受到很大限制，CPU与共享存储器间的信息交换成了影响高速计算和系统系能的“瓶颈”。

2、哈佛结构

​	冯诺·伊曼结构在面对高速、实时处理时，不可避免地会造成总线拥挤。

哈佛结构的指令和数据是完全分开的，存储器分为两部分，一个是程序存储器，用来存放指令，另一个是数据存储器，用来存放数据。
